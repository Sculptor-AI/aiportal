...
export const MAX_AGENTS_GO_DEEPER = 100;
export const DEFAULT_AUTO_AGENTS_FALLBACK = 3;

export const GO_DEEPER_AGENT_TEMPERATURE = 1.0;
export const GO_DEEPER_AGENT_FOCUS_PROMPT = (topic) => `You are an independent, highly creative research agent. Your main research topic is: "${topic}".
...
export const GEMINI_SYNTHESIS_MODEL = 'gemini-2.5-flash-preview-04-17';
